            ...
            <div class="row ratio_55">
                <div class="col-12 property-grid-3">
                    <div class="property-2 row column-sm zoom-gallery property-label property-grid">
                        <div class="col-xl-4 col-md-6 sale grid-item wow fadeInUp"
                            v-for="(item, index) in Releted_Product" :key="index">
                            <div class="property-box ">
                                <div class="property-image btn-color">
                                    ...
                                    <div class="labels-left">
                                        ...
                                        <span v-if="item.label[1]" class="label label-success">{{ item.label[1]
                                            }}</span>
                                    </div>
                                    <div class="seen-data">
...
const Releted_Product: rent[] = single.value.related
