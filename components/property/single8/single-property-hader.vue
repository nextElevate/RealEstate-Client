            ...
            <div class="container">
                <div class="single-title">
                    <div class="left-single">
                        ...
                        <p class="mt-1">Mina Road, Bur Dubai, Dubai, United Arab Emirates</p>
                        <ul>
                            <li v-for="(item, index) in ALl_Options" :key="index">
                                <div>
...
const ALl_Options: Options[] = single.value.options
function getprint() {
    window.print();
}
</script>
