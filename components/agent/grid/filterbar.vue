...
const { data: addedData }:FetchResponse = await useFetch(useurl + '/data/left-sidebar-filter.json');
const { data: singleData }:FetchResponse = await useFetch(useurl + '/data/propertysingleiamge.json');
