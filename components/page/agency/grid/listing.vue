                ...
                <ul class="grid-list-filter d-flex">
                    ...
                    <li class="collection-grid-view" :class="active == 'list' ? 'd-none' : ''">
                        <ul>
                            ...
                            <li @click="classes = 'col-md-3'"><img src="/image/icon/4.png" alt=""
