    ...
    <div class="col-lg-7">
        <div class="container">
            <div class="home-left">
                ...
                <div class="looking-icons" v-for="(item, index) in data.data" :key="index">
                    <h5>{{ item.heading }}</h5>
                    <ul>
                        <li v-for="(sub, index) in item.icons" :key="index">
                            <nuxt-link :to="sub.path" class="looking-icon">
...
let { data } = await useFetch("https://sheltos-vue.vercel.app" + '/data/looking-icon.json')
</script>
