          ...
          <div class="col-xl-4 col-lg-3">
            <div class="feature-left">
              <div class="property-details">
                ...
                <nuxt-link :to="'/property/single-property-10/' + item._id" @click="getimg(item.img)">
                  <h3 class="d-flex">
                    {{ item.propertyType }}
                    <span><span class="label label-gradient color-6">VIP</span></span>
                  </h3>
                </nuxt-link>
                <h6 class="color-6">
                  {{ item.price
                ...
                <div class="property-btn">
                  <nuxt-link :to="'/property/single-property-8/' + item.sku" class="btn btn-dashed btn-pill color-6"
                    @click="getimg(item.image[0])" tabindex="0">{{ "Подробности" }}</nuxt-link>
                </div>
              </div>
            </div>
          </div>
          <div class="col-xl-8 col-lg-9 order-md">
            <div class="feature-image back-image" :style="'background-image: url(' + item.image[0] + ')'">
