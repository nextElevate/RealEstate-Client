<template>
    <div class="col-xl-9 col-lg-8">
        <div class="blog-grid row mb-0">
            <div :class="item.first?'col-md-12':'col-md-6'" v-for="(item , index) in getdata()" :key="index"> 
                <div class="blog-wrap wow fadeInUp">
                    ...
                    <div class="blog-details">
                        <div>
                            <span><Icon name="majesticons:map-marker-line" /> {{ item.place }}</span>
